...
fun ICorChainDsl<CompanyContext>.getOwnerCompanies(title: String) = worker {
	...
	handle {
		companies = companyRepository.getCompaniesByOwnerId(ownerId = principalUser.id, filter = searchFilter)
	}
}