...
fun ICorChainDsl<UserContext>.getUsersByCompanyFromDb(title: String) =
	worker {
		...
		handle {
			users.addAll(userRepository.getUsersByCompany(companyId = companyIdValid, filter = searchFilter))
		}
	}