...
class GetUserAwardCountAggregateTest : KoinTest {

	private val userRepository by inject<UserRepository>(UserRepository::class.java)

	@Test
	fun `Получение количества сотрудников с наградами по отделам`() {
		...
		testApplication {
			...
			userRepository.getUsersAwardsCountAggregate(companyId = companyId)
